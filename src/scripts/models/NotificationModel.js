...
export class NotificationModel {
    ...
    async subscribeToNotifications(subscription) {
        try {
            ...
            // Kirim hanya field yang dibutuhkan API Dicoding
            let subObj = subscription.toJSON ? subscription.toJSON() : subscription;
            ...
            const response = await this.apiService.subscribeNotification(filteredSubscription, token);
